...
public sealed partial class SmartBirdThermostatViewModel : MyPowerTools.AvaloniaSdk.ToolSurfacePageViewModel
{
            ...
            MyPowerTools.AvaloniaSdk.ToolSurfaceState.Ready)
    {
        ...
        RefreshCommand = new MptAsyncRelayCommand(RefreshAsync, () => !IsBusy);
        StartServiceCommand = new MptAsyncRelayCommand(StartServiceAsync, () => CanStartService);
        OpenInBrowserCommand = new MptAsyncRelayCommand(
    ...
    public bool IsBusy
    {
        ...
        private set
        {
            ...
            ((MptAsyncRelayCommand)StartServiceCommand).NotifyCanExecuteChanged();
            ((MptAsyncRelayCommand)OpenInBrowserCommand).NotifyCanExecuteChanged();
